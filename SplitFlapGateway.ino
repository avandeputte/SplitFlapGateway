...
/* ---- Firmware identity ---- */
#define FW_VERSION           "1.9"            // gateway firmware version (UI + boot log)
...
void handleRoot() {
  ...
  server.sendContent("<link rel=\"icon\" type=\"image/svg+xml\" href=\"/favicon.svg\">");
  ...
  server.sendContent(".brand{height:26px;vertical-align:middle;display:inline-block}@media(max-width:640px){.brand{height:18px}}");
  ...
  server.sendContent(".micons{position:absolute;bottom:6px;right:6px;display:flex;gap:8px;align-items:center}");
